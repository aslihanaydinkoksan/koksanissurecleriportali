                ...
                <div class="card edit-team-card">
                    ...
                    <div class="card-body p-4 p-md-5">
                        ...
                        <form method="POST" action="{{ route('teams.update', $team->id) }}">
                            ...
                            <div class="mb-4">
                                <label for="user_ids" class="form-label form-label-edit">
                                    <i class="fas fa-user-friends"></i>
                                    Takım Üyeleri
                                    <span style="color: #f56565;">*</span>
                                </label>
                                <select name="user_ids[]" id="user_ids" class="form-select form-select-edit" multiple
                                    required>
                                ...
                                <div class="form-text form-text-edit">
                                    <i class="fas fa-info-circle"></i>
                                    Birden fazla kişi seçmek için <kbd>CTRL</kbd> + Tık veya <kbd>CMD</kbd> + Tık kullanın.
                                </div>
                            </div>
