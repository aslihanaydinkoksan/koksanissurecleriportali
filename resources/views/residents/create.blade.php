    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb bg-transparent p-0 m-0 small">
                ...
                <li class="breadcrumb-item active text-primary" aria-current="page">Yeni Ekle</li>
            </ol>
        </nav>
    </div>
            ...
            <div class="card border-0 shadow-sm rounded-4">
                ...
                <div class="card-header bg-white border-bottom-0 pt-4 px-4 pb-0">
                    <div class="d-flex align-items-center gap-3">
                        ...
                        <div>
                            <h5 class="fw-bold text-dark mb-0">Yeni Kişi Tanımla</h5>
                            <p class="text-secondary small mb-0">Sisteme yeni bir personel veya misafir kaydı oluşturun</p>
                        </div>
                    </div>
                </div>
                    ...
                    <form action="{{ route('residents.store') }}" method="POST">
                        ...
                        <div class="row g-3 mb-4">
                            <div class="col-md-6">
                                ...
                                <input type="text" name="first_name" class="form-control" placeholder="Örn: Ahmet"
                                    required>
                            </div>
                            <div class="col-md-6">
                                <label class="form-label fw-medium text-secondary small">Soyadı <span
                                        class="text-danger">*</span></label>
                                <input type="text" name="last_name" class="form-control" placeholder="Örn: Yılmaz"
                                    required>
                            </div>
                            <div class="col-md-6">
                        ...
                        <div class="row g-3 mb-4">
                            ...
                            <div class="col-md-6">
                                ...
                                <select name="employment_type" class="form-select">
                                    ...
                                    <option value="contractor">Taşeron / Yüklenici</option>
