<div class="modal fade" id="kvkkModal" tabindex="-1" aria-labelledby="kvkkModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content border-0 shadow-lg" style="border-radius: 1.25rem; overflow: hidden;">
            ...
            {{-- Modal İçerik (PDF Görüntüleyici) --}}
            <div class="modal-body p-0" style="background-color: #f8f9fa;">
                <iframe src="{{ asset('docs/kvkk-web-sitesi-aydinlatma-metni-.pdf') }}#toolbar=0&navpanes=0&scrollbar=0" width="100%"
                    ...
                    <p class="text-center p-4">
                        ...
                        <a href="{{ asset('docs/kvkk-web-sitesi-aydinlatma-metni-.pdf') }}" target="_blank" class="text-primary">
            ...
            <div class="modal-footer border-0 p-4"
                ...
                {{-- Mobil ve Edge Caseler için İndirme / Yeni Sekmede Açma Linki --}}
                <a href="{{ asset('docs/kvkk-web-sitesi-aydinlatma-metni-.pdf') }}" target="_blank" class="text-decoration-none"
