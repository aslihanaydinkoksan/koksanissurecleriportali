                ...
                <div class="card-body p-4 p-md-5">
                    <form method="POST" action="{{ route('login') }}">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-8">
                                <input id="email" type="email" class="form-control rounded-soft @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}" required autocomplete="email" autofocus>
                                @error('email')
