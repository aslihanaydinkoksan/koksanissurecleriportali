...
@section('content')
    ...
    <style>
        ...
        .login-card {
            border-radius: 1rem;
            /* Köşeleri daha yumuşak */
            box-shadow: 0 1rem 3rem rgba(0, 0, 0, 0.1) !important;
            border: 0;
            background-color: rgba(255, 255, 255, 0.85);
            /* Hafif şeffaflık */
            backdrop-filter: blur(5px);
            /* Arka planı bulanıklaştır (iOS/Safari) */
        }
        ...
        .link-palette {
            color: #667EEA;
            /* Paletten canlı mavi-mor */
            text-decoration: none;
            font-weight: 500;
            /* Normalden biraz kalın */
        }

        .link-palette:hover {
            color: #435EBE;
            /* Mavi-morun koyu tonu */
                ...
                <div class="card login-card shadow-lg">
                    ...
                    <div class="card-body p-4 p-md-5">
                        <form method="POST" action="{{ route('login') }}">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-8">
                                    <input id="email" type="email"
                                        class="form-control rounded-soft @error('email') is-invalid @enderror"
                                ...
                                <div class="col-md-8">
                                    <div class="input-group rounded-soft">
                                        ...
                                        <button class="btn btn-outline-secondary" type="button" id="togglePassword">
                                            <svg id="eyeIcon" xmlns="http://www.w3.org/2000/svg" width="16"
                            ...
                            {{-- DÜZELTME 1: RECAPTCHA KUTUSU FORMUN İÇİNE GELDİ --}}
                            @if ($showCaptcha ?? false)
                                <div class="row mb-3">
                                    <div class="col-md-8 offset-md-4">

                                        {!! htmlFormSnippet() !!} {{-- Kutu (HTML) burada --}}

                                        {{-- CAPTCHA için hata mesajı --}}
                            ...
                            <div class="row mb-0">
                                <div class="col-md-8 offset-md-4 d-flex align-items-center">
                                    ...
                                    @if (Route::has('password.request'))
                                        <a class="link-palette ms-3" href="{{ route('password.request') }}">
                                            Şifreni mi unuttun?
                                        </a>
                                    @endif
                                </div>
...
@section('page_scripts')
    ...
    {{-- DÜZELTME 2: RECAPTCHA'NIN JAVASCRIPT'İ BURAYA GELDİ --}}
    @if ($showCaptcha ?? false)
        {!! htmlScriptTagJsApi(['lang' => 'tr']) !!} {{-- DÜZELTME BURADA --}}
    @endif
    {{-- DÜZELTME 2 SONU --}}

    {{-- Şifre gösterme/gizleme JavaScript'i (Değişiklik yapılmadı) --}}
    <script>
