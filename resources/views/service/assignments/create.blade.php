                        ...
                        <form method="POST" action="{{ route('service.assignments.store') }}">
                            ...
                            <div x-show="currentStep === 1" class="fade-in-up">
                                ...
                                <label class="selection-card">
                                    {{-- Düzeltme 2: @change eventi güncellendi. Varsayılan araç tipini ayarlar. --}}
                                ...
                                <label class="selection-card">
                                    <input type="radio" name="needs_vehicle" value="no" x-model="needsVehicle"
                                        {{-- Düzeltme 2: Araç gereksiz ise vehicleType'ı boşaltıp Adım 2'ye geç --}} @change="vehicleType = ''; currentStep = 2">
                                    <div class="card-content">
                                        <div class="card-icon">👤</div>
                                        <div class="card-text">
                                ...
                                <div x-show="needsVehicle === 'yes'" class="mt-4 fade-in-up">
                                    ...
                                    <label class="selection-card">
                                        {{-- Şirket Aracı seçildiğinde adımı 2 yap: --}}
                                    ...
                                    <label class="selection-card">
                                        {{-- Nakliye Aracı seçildiğinde adımı 2 yap: --}}
                            ...
                            <div x-show="currentStep === 2" class="fade-in-up">
                                <button type="button" class="btn btn-sm btn-outline-secondary mb-3" {{-- Düzeltme: currentStep mantığına göre geri butonu sadece 1. adıma döner --}}
                                ...
                                <label class="selection-card">
                                    <input type="radio" name="responsible_type" value="user" x-model="responsibleType"
                                        {{-- Düzeltme 2: Seçilince Adım 3'e geçiş. responsibleType boş string'ten 'user'a geçtiği için reaktivite sorunu çözülmüştür. --}} @change="currentStep = 3">
                                    <div class="card-content">
                                        <div class="card-icon">👤</div>
                                        <div class="card-text">
                                            <h6>Tek Kişi</h6>
                            ...
                            <div x-show="currentStep === 3" class="fade-in-up">
                                <button type="button" class="btn btn-sm btn-outline-secondary mb-3" {{-- Düzeltme: currentStep mantığına göre geri butonu 2. adıma döner --}}
                                    @click="currentStep = 2">
                                    ← Geri
                                </button>
                                ...
                                {{-- Düzeltme: needsVehicle boş string'ten bir değere değiştiği için artık düzgün çalışır. --}}
                                <div x-show="needsVehicle === 'yes'" class="mb-4">
                                    ...
                                    {{-- Düzeltme: HTML'deki required kaldırıldı, Alpine.js'e taşındı. --}}
                                    <select name="vehicle_id" class="form-select"
                                        ...
                                        <template x-if="vehicleType === 'logistics'">
                                            @foreach ($vehicles->where('type', 'logistics') as $vehicle)
                                                <option value="{{ $vehicle->id }}">
                                ...
                                {{-- Düzeltme: needsVehicle koşulu eklendi --}}
                                ...
                                {{-- Düzeltme: responsibleType boş string'ten 'user'a değiştiği için artık düzgün çalışır. --}}
                                ...
                                <div class="mb-4">
                                    ...
                                    <textarea name="task_description" class="form-control" rows="3"                                        
                                        placeholder="Ne yapılması gerekiyor? Detaylı açıklayın..." required>{{ old('task_description') }}</textarea>
                                ...
                                <div class="d-flex justify-content-between align-items-center mt-4 pt-3 border-top">
                                    <a href="{{ route('service.assignments.index') }}" class="btn btn-outline-secondary">
                                        İptal
                                    </a>
            ...
            <div class="modal-content">
                ...
                <form id="newTeamForm" action="{{ route('teams.store') }}" method="POST">
                    ...
                    <div class="modal-body">
                        ...
                        {{-- Düzeltme 3: Takım kuralını karşılamak için ilk üye seçimi eklendi --}}
                        <div class="mb-3">
