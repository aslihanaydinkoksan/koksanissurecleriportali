@extends('layouts.app')
@section('title', 'Genel Görev Listesi (Araçsız)')
                    ...
                    <div class="task-meta">
                                    ...
                                    @if ($assignment->responsible)
                                        <div class="responsible-badge">
                                            ...
                                            <span
                                                ...
                                                {{ $assignment->responsible_type === 'App\Models\User' ? 'Kişi' : 'Takım' }}
                                            </span>
                                        </div>
                                    @else
                        ...
                        <div class="meta-item">
                            ...
                            <div class="meta-content">
                                ...
                                <div class="meta-value">{{ $assignment->destination ?? 'Belirtilmemiş' }}</div>
                            </div>
                        </div>
