    ...
    <div class="container-fluid">
        <div class="row justify-content-center">
            <div class="col-md-12">
                ...
                {{-- === ARAÇ ATAMA FİLTRELEME BÖLÜMÜ === --}}
                <div class="mb-4">
                    <div class="d-grid gap-2 d-md-flex justify-content-md-between">
                        {{-- Yeni Atama Ekle Butonu --}}
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <select class="form-select form-select-sm" id="vehicle_id" name="vehicle_id">
                                            ...
                                            {{-- Controller'dan gelen $vehicles değişkenini kullanıyoruz --}}
                                ...
                                <table class="table table-striped table-hover mb-0">
                                    <thead>
                                        ...
                                        <tr>
                                            ...
                                            <th scope="col">Atanan Sefer Zamanı</th> {{-- GÜNCELLENDİ --}}
                                            {{-- Bitiş sütunu kaldırıldı --}}
                                            <th scope="col" class="text-end pe-3">İşlemler</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        {{-- Döngü güncellendi: $assignments as $assignment --}}
                                        @foreach ($assignments as $assignment)
                                            <tr>
                                                {{-- Tablo verileri güncellendi (İlişkili veriler kullanıldı) --}}
                                                <td class="ps-3 fw-bold">
                                                    {{ $assignment->vehicle->plate_number ?? 'Silinmiş Araç' }}</td>
                                                <td>{{ $assignment->task_description }}</td>
                                                <td>{{ $assignment->destination ?? '-' }}</td>
                                                <td>{{ $assignment->requester_name ?? '-' }}</td>
                                                <td>{{ $assignment->start_time->format('d.m.Y H:i') }}</td>
                                                {{-- GÜNCELLENDİ (Sefer Saati) --}}
                                                {{-- Bitiş saati kaldırıldı --}}
