...
@section('content')
    <div class="container-fluid d-flex flex-column" style="height: 95vh;">
        ...
        {{-- 3. ALT BÖLÜM (Sol: Bildirimler, Sağ: Grafik) --}}
        <div class="row g-4 flex-grow-1">

            {{-- SOL TARA: ÖNEMLİ BİLDİRİMLER --}}
                        ...
                        <div class="d-flex flex-column gap-2">
                            @foreach ($importantItems as $item)
                                <div class="important-item">
                                    ...
                                    <div>
                                        <h4 class="fw-bold mb-1 text-dark" style="font-size: 1.3rem;">{{ $item->title }}
                                        </h4>
                                        <div class="text-muted fs-5">
                                            <i class="far fa-clock me-1"></i> {{ $item->date->format('H:i') }}
