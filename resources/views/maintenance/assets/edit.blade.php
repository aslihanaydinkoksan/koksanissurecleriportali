...
@section('title', 'Makine Detaylarını Düzenle')
    ...
    <div class="container-fluid modern-container">
        ...
        <div class="d-flex align-items-center mb-4">
            ...
            <div>
                ...
                <small class="text-white-50">#{{ $asset->id }} - {{ $asset->name }} kaydını güncelliyorsunuz</small>
            </div>
        </div>
                ...
                <div class="card form-card">
                    ...
                    <div class="card-body p-4 p-md-5">
                        ...
                        <form action="{{ route('maintenance.assets.update', $asset->id) }}" method="POST"
                            autocomplete="off">
                            @csrf
                            @method('PUT') {{-- Güncelleme işlemi için zorunlu --}}
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select class="form-select" id="category" name="category" required>
                                            ...
                                            <option value="zone"
                                                {{ old('category', $asset->category) == 'zone' ? 'selected' : '' }}>Bölge
                                                (Zone/Oda)</option>
