@extends('layouts.app')
@section('title', 'Tüm Önemli Bildirimler')
...
@section('content')
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-10"> {{-- Daha geniş bir alan --}}
                <div class="mb-4">
                    <div class="d-grid">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <select class="form-select form-select-sm" id="type" name="type">
                                            <option value="all"
                                                {{ ($filters['type'] ?? 'all') == 'all' ? 'selected' : '' }}>Tümü</option>
                                            <option value="shipment"
                                                {{ ($filters['type'] ?? '') == 'shipment' ? 'selected' : '' }}>Sevkiyat
                                            </option>
                                            <option value="production_plan"
                                                {{ ($filters['type'] ?? '') == 'production_plan' ? 'selected' : '' }}>Üretim
                                                Planı</option>
                                            <option value="event"
                ...
                <div class="card create-shipment-card mb-4">
                    ...
                    <div class="card-header d-flex justify-content-between align-items-center"
                        ...
                        <h5 class="mb-0" style="color: #dc3545; font-weight: 700;">
                            <i class="fas fa-bell"></i> Tüm Önemli Bildirimler ({{ $importantItems->count() }} adet)
                        </h5>
                        <a href="{{ route('welcome') }}" class="btn btn-sm btn-outline-secondary">← Geri Dön</a>
                    </div>
