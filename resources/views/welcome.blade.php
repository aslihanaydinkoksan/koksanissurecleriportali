    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-12">
                                ...
                                @forelse($todayItems as $item)
                                    @if ($departmentSlug === 'uretim')
                                        ...
                                        <div class="list-group-item d-flex align-items-center py-3">
                                            ...
                                            <a href="{{ route('home') }}?open_modal_id={{ $item->id }}&open_modal_type=production_plan"
                                    ...
                                    @elseif($departmentSlug === 'hizmet')
                                        ...
                                        <div class="list-group-item d-flex align-items-center py-3">
                                            ...
                                            <div class="d-flex flex-column flex-grow-1">
                                                ...
                                                <p class="mb-0 text-muted">{!! $detay !!} <span
                                                        class="mx-2">|</span>
                                                    <strong>{{ $isTravel ? 'Başlangıç' : 'Saat' }}:</strong> <span
                                                        class="fw-bold text-dark">{{ $saat }}</span>
                                                </p>
                                            </div>
                ...
                @if ($todayItems->isNotEmpty() && (Auth::user()->role === 'admin' || $departmentSlug === null))
                    <h4 class="mt-4">
                            ...
                            @forelse($todayItems as $item)
                                ...
                                <div class="list-group-item d-flex align-items-center py-2"
                                    ...
                                    <div class="vehicle-icon me-3">
                                        <i class="fa-solid {{ $icon }} fa-lg" style="color: #667EEA;"></i>
                                    </div>
                                    <div class="d-flex flex-column flex-grow-1">
                                        <span class="mb-0 {{ $colorClass }}">{{ $baslik }}</span>
                                        <small class="text-muted">{{ $detay }}</small>
                                    </div>
                                    <span class="{{ $colorClass }} ms-auto">{{ $saat }}</span>
