            ...
            <div class="modal-content"
                ...
                <div class="modal-body p-4">
                    ...
                    <div class="d-grid gap-3">
                        ...
                        @endif
                        {{-- YENİ: 5. BAKIM PLANI (Sadece Bakım Departmanı veya Admin) --}}
        ...
        <div class="row justify-content-center">
            <div class="col-12">
                <div class="card create-shipment-card mb-4">
                                ...
                                <div class="card shadow-sm border-0"
                                    ...
                                    <div class="card-body p-0">
                                        ...
                                        @foreach ($groups as $key => $group)
                                            {{-- AYLIK KISMI İÇİN ÖZEL WRAPPER (Varsayılan Gizli) --}}
                                            @if ($key === 'month')
                                            ...
                                            <div class="p-3 bg-light bg-opacity-50 d-flex align-items-center">
                                                <i class="fa-solid {{ $group['icon'] }} me-2"
                                                    style="color: {{ $group['color'] }};"></i>
                                                <h6 class="mb-0 fw-bold text-uppercase" style="color: #555;">
                                                    {{ $group['title'] }}</h6>
                                                <span
                                                    class="badge bg-secondary ms-2 rounded-pill">{{ count($group['data']) }}</span>
                                            </div>

                                            {{-- LİSTE --}}
                                            <div class="list-group list-group-flush mb-2">
                                                @forelse($group['data'] as $item)
                                                    @php
                                                    ...
                                                    <div
                                                        ...
                                                        <div class="me-3">
                                                            <div class="d-flex align-items-center justify-content-center rounded-circle"
                                                                ...
                                                                <i
                                                                    class="fa-solid {{ $icon }} {{ $iconClass }}"></i>
                                                            </div>
                                                        </div>
                                                        <div class="flex-grow-1">
                                                            <h6 class="mb-0 text-dark fw-bold"
                                                                style="font-size: 0.95rem;">{{ $baslik }}</h6>
                                                            <small class="text-muted">{{ $detay }}</small>
                                                        </div>
                                                        <div class="text-end ms-3">
                                                            <span
                                                                class="d-block fw-bold text-dark small">{{ $gosterimSaat }}</span>
                                                            <span class="text-muted"
                                                                style="font-size: 0.65rem;">{{ $gosterimTarih }}</span>
                                                        </div>
                    ...
                    {{-- JAVASCRIPT: SEÇİME GÖRE LİSTEYİ DEĞİŞTİR --}}
                    <script>
                        document.addEventListener('DOMContentLoaded', function() {
