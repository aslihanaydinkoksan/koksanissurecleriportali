            ...
            <div class="col-12">
                ...
                <div class="card create-shipment-card mb-4">
                    <div class="card-body p-4">
                        ...
                        <div class="row align-items-center mb-3">
                            <div class="col-md-7">
                                ...
                                @if (Auth::user()->department)
                                    {{-- <p class="mb-0 text-muted fs-5">{{ Auth::user()->department->name }} Departmanı</p> --}}
                                @else
                        ...
                        {{-- ========================================================= --}}
                        {{-- YENİ EKLENEN BLOK 1: KPI KARTLARI --}}
                        {{-- Sadece $kpiData dizisi doluysa bu bloğu göster. --}}
                        {{-- ========================================================= --}}
                            ...
                            <div class="row g-4 mt-2 mb-3">
                                ...
                                <div class="col-lg-3 col-md-6">
                                    <div class="kpi-card kpi-hizmet">
                                        ...
                                        <div class="kpi-value">{{ $kpiData['gorev_sayisi'] }}</div>
                        ...
                        {{-- ========================================================= --}}
                        {{-- MEVCUT BLOK 2: "Bugün..." Listesi --}}
                        {{-- Sadece $todayItems koleksiyonu doluysa bu bloğu göster. --}}
                        {{-- (Admin ve Departmansız Yönetici için bu blok gizlenecek) --}}
                        {{-- ========================================================= --}}
                        @if ($todayItems->isNotEmpty())
                            ...
                            <div class="list-group mt-3">
                                @forelse($todayItems as $item)
                                    {{-- 1. Üretim Gösterimi (Sadece 'uretim' departmanı) --}}
                                    @if ($departmentSlug === 'uretim')
                                        ...
                                        {{-- 2. Hizmet Gösterimi (Sadece 'hizmet' departmanı) --}}
                                    @elseif($departmentSlug === 'hizmet')
                                        @php
                                            ...
                                            $baslik = $isEvent
                                                ? $item->title
                                                : 'Araç Görevi: ' . $item->task_description;
                                        @endphp
                                        <div class="list-group-item d-flex align-items-center py-3">
                                            <div class="me-3"><i
                                                    class="fa-solid {{ $iconInfo['icon'] }} fa-2x vehicle-icon {{ $iconInfo['class'] }}"></i>
                                        ...
                                        {{-- 3. Lojistik Gösterimi (Sadece 'lojistik' departmanı) --}}
                                    ...
                                    @endif
                                @empty
                                    {{-- Bu @empty bloğu $todayItems boşsa (Admin/Departmansız) çalışmayacak, çünkü tüm blok @if ($todayItems->isNotEmpty()) içinde --}}
                                @endforelse
                            </div>
                        @endif
                        {{-- @if ($todayItems->isNotEmpty()) Bitişi --}}

                    </div>
                </div>

                {{-- ========================================================= --}}
                {{-- MEVCUT BLOK 3: Sankey Diyagramı --}}
                {{-- Sadece $chartData dizisi doluysa bu bloğu göster. --}}
                {{-- (Admin ve Departmansız Yönetici için ŞİMDİ GÖSTERİLECEK) --}}
                {{-- ========================================================= --}}
