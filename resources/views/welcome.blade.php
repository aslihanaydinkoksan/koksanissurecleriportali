...
$isAdmin = in_array($currentUser->role, ['admin', 'yönetici']);
                    ...
                    <div class="d-grid gap-3">
                        ...
                        {{-- 4. ARAÇ GÖREVİ (GÜNCELLENDİ: ULAŞTIRMA ve HİZMET) --}}
                        @if (Route::has('service.assignments.create') && ($isAdmin || $userDept === 'hizmet' || $userDept === 'ulastirma'))
                    ...
                    <div class="card-body p-4">
                                        ...
                                        @foreach ($importantItems as $item)
                                            ...
                                            <a href="{{ $url }}"
                                                ...
                                                <div class="d-flex align-items-center overflow-hidden">
                                                    <i
                                                        class="fas {{ $isOverdue ? 'fa-exclamation-circle' : 'fa-exclamation-triangle' }} text-danger me-2 flex-shrink-0"></i>
                                                ...
                                                @if ($item->date)
                                                    <div class="d-flex flex-column align-items-end ms-3 flex-shrink-0">
                                                        <span
                                                            class="fw-bold text-danger fs-6">{{ $item->date->format('H:i') }}</span>
                                                        <span class="text-muted small"
                                                            style="font-size: 0.7rem;">{{ $item->date->format('d.m.Y') }}</span>
                                                    </div>
                                                @endif
                                            </a>
                                        @endforeach
                                    </div>
                                    @if ($importantItemsCount > 4)
                                        <div class="text-center mt-3">
                                            <a href="{{ route('important.all') }}"
                                                class="btn btn-outline-danger btn-sm">Tüm ({{ $importantItemsCount }})
                                                Veriyi Görüntüle...</a>
                                        </div>
                                    @endif
                                </div>
                        ...
                        @if (isset($kpiData) && !empty($kpiData))
                            ...
                            <div class="row g-4 mt-2 mb-3">
                                ...
                                {{-- DEPARTMANA ÖZEL KART GÖSTERİMİ --}}
                                @php
                                    $showAll = $isAdmin || empty($userDept);
                                @endphp

                                {{-- ULAŞTIRMA KARTLARI (MÜDÜR İÇİN BURASI ÇALIŞACAK) --}}
                                @if ($showAll || $userDept === 'ulastirma')
                                    @if (isset($kpiData['aktif_gorev']))
                                        ...
                                        <div class="col-lg col-md-4 col-6">
                                            <div class="kpi-card kpi-ulastirma h-100">
                                                ...
                                                <div class="kpi-value">{{ $kpiData['bekleyen_talep'] }}</div>
                                        ...
                                        <div class="col-lg col-md-4 col-6">
                                            <div class="kpi-card kpi-ulastirma h-100">
                                                ...
                                                <div class="kpi-value">{{ $kpiData['toplam_arac'] }}</div>
                                        ...
                                        <div class="col-lg col-md-4 col-6">
                                            <div class="kpi-card kpi-ulastirma h-100">
                                                ...
                                                <div class="kpi-value">{{ $kpiData['bugunku_gorev'] }}</div>
                                ...
                                @if ($showAll)
                                    ...
                                    <div class="col-lg col-md-4 col-6">
                                        <div class="kpi-card kpi-bakim h-100">
                                            ...
                                            <div class="kpi-value">{{ $kpiData['bakim_sayisi'] ?? 0 }}</div>
