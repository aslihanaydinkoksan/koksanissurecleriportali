        ...
        <div class="row g-3 align-items-center">
            ...
            <div class="col-md-4">
                <div class="form-check form-switch d-flex align-items-center gap-2">
                    ...
                    <label class="form-check-label fw-bold mb-0" for="is_active" id="is_active_label"
                        ...
                        <?php echo e(old('is_active', $customer->is_active ?? true) ? 'Aktif Müşteri' : 'Pasif Müşteri'); ?>
            ...
            <div class="col-md-4">
                <div class="form-floating">
                    <input type="date" class="form-control form-control-sm <?php $__errorArgs = ['start_date'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                        ...
                        value="<?php echo e(old('start_date', isset($customer->start_date) ? \Carbon\Carbon::parse($customer->start_date)->format('Y-m-d') : '')); ?>">
            ...
            <div class="col-md-4" id="end_date_container" style="display: none;">
                <div class="form-floating">
                    <input type="date" class="form-control form-control-sm <?php $__errorArgs = ['end_date'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                        ...
                        value="<?php echo e(old('end_date', isset($customer->end_date) ? \Carbon\Carbon::parse($customer->end_date)->format('Y-m-d') : '')); ?>">
...
<?php /**PATH C:\xampp\htdocs\koksanissurecleriportali-main\resources\views/customers/_form.blade.php ENDPATH**/ ?>