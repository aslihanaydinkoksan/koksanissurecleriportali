                        ...
                        <?php if($activeEntry): ?>
                            ...
                            <div class="timer-widget active">
                                <div class="text-primary fw-bold mb-2 animate-pulse">
                                    ...
                                    <?php if(!$isMyTimer): ?>
                                        <div class="text-muted small fw-normal mt-1">
                                            <i class="fas fa-user me-1"></i> <?php echo e($activeEntry->user->name); ?> tarafından
                                        </div>
                                    <?php endif; ?>
                                </div>
                                ...
                                <small class="text-muted d-block mb-3">
                                    Başlangıç: <?php echo e($activeEntry->start_time->format('H:i:s')); ?>

                                </small>

                                
                                <?php if($isMyTimer || Auth::user()->role == 'admin'): ?>
...
<?php $__env->startSection('page_scripts'); ?>
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            <?php if($jsActiveEntry): ?>
                // If there is an active timer, run the JS clock for everyone
                const startTimeString = "<?php echo e($jsActiveEntry->start_time->format('Y-m-d H:i:s')); ?>";
