...
<?php $__env->startSection('title', 'Kanban Panosu: ' . $board->name); ?>
...
<?php $__env->startSection('content'); ?>
    ...
    <div class="d-flex justify-content-between align-items-center mb-3 px-3">
        ...
        <div>
            <a href="<?php echo e($backRoute); ?>" class="btn btn-sm btn-secondary shadow-sm">
        ...
        <?php $__currentLoopData = $board->columns; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $column): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            ...
            <div class="kanban-column">
                ...
                <div class="kanban-column-header">
                    <span class="<?php echo e(str_replace('border-left-', 'text-', $borderOnly)); ?>-custom">
                        <?php echo e($column->title); ?>

                    </span>
                    <span class="badge bg-secondary text-white rounded-pill"><?php echo e($column->cards->count()); ?></span>
                </div>

                
                <div class="kanban-column-body" id="column-<?php echo e($column->id); ?>" data-column-id="<?php echo e($column->id); ?>">
                    <?php $__currentLoopData = $column->cards; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $card): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php if($card->model): ?>
                            <div class="kanban-card <?php echo e($borderOnly); ?>" data-card-id="<?php echo e($card->id); ?>">

                                
                                <div class="card-meta">
                                    <span>#<?php echo e($card->model->id); ?></span>
                                    <span><?php echo e($card->created_at->format('d.m')); ?></span>
                                </div>

                                
                                <div class="card-title">
                                    <?php echo e($card->model->title ?? ($card->model->plaka ?? 'Başlıksız İş')); ?>

                                </div>

                                
                                <div class="card-details">
                                    <?php if(isset($card->model->sofor_adi)): ?>
                                        <i class="fas fa-user-circle"></i> <?php echo e($card->model->sofor_adi); ?>

                                    <?php elseif(isset($card->model->description)): ?>
                                        <i class="fas fa-align-left"></i> <?php echo e(Str::limit($card->model->description, 30)); ?>

                                    <?php endif; ?>
                                </div>

                                
                                <?php if(isset($card->model->priority) && $card->model->priority == 'high'): ?>
    ...
    <script>
        ...
        function updateCardPosition(cardId, targetColumnId, newIndex) {
            axios.post('<?php echo e(route('kanban.move')); ?>', {
                    card_id: cardId,
        ...
        function openCardModal(cardId) {
            ...
            axios.get(`<?php echo e(url('/kanban/card')); ?>/${cardId}`)
                .then(res => {
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp82\htdocs\koksanissurecleriportali\resources\views/admin/kanban/board.blade.php ENDPATH**/ ?>