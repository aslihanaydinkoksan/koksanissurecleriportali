            ...
            <div class="col-md-10">
                <div class="customer-card">
                    <div class="card-header bg-transparent border-0 px-4 pt-4">
                        <h4 class="mb-0">Müşteri Bilgilerini Düzenle</h4>
                    </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\koksanissurecleriportali\resources\views/customers/edit.blade.php ENDPATH**/ ?>