                                ...
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-md-2">
                                        <div class="text-muted small"
                                            ...
                                            Başlangıç</div>
                                        <div class="fw-bold text-dark"><?php echo e($event->start_datetime->format('d.m.Y')); ?></div>
                                        <div class="small text-muted"><?php echo e($event->start_datetime->format('H:i')); ?></div>
                                    </div>
                                    ...
                                    <div class="col-md-2">
                                        <div class="text-muted small"
                                            style="font-size: 0.75rem; text-transform: uppercase; letter-spacing: 0.5px;">
                                            Bitiş</div>
                                        <div class="fw-bold text-dark"><?php echo e($event->end_datetime->format('d.m.Y')); ?></div>
                                        <div class="small text-muted"><?php echo e($event->end_datetime->format('H:i')); ?></div>
                                    </div>
                ...
                <?php else: ?>
                                ...
                                <div class="row g-3">
                                    ...
                                    <div class="col-lg-2 col-md-6">
                                        ...
                                        <select class="form-select" name="event_type">
                                            ...
                                            <option value="visit"
                                                <?php echo e(($filters['event_type'] ?? '') == 'visit' ? 'selected' : ''); ?>>Müşteri
                                                Ziyareti</option>
                                            <option value="meeting"
                                                <?php echo e(($filters['event_type'] ?? '') == 'meeting' ? 'selected' : ''); ?>>
                                                Toplantı</option>
                                            <option value="fuar"
                                                <?php echo e(($filters['event_type'] ?? '') == 'fuar' ? 'selected' : ''); ?>>Fuar
                                            </option>
                                            <option value="egitim"
                                                <?php echo e(($filters['event_type'] ?? '') == 'egitim' ? 'selected' : ''); ?>>Eğitim
                                            </option>
                                        </select>
                                    </div>
                                    <div class="col-lg-2 col-md-6">
                    ...
                    <div class="mb-4 text-end">
                        ...
                        <div class="dropdown d-inline-block">
                            <button class="modern-btn modern-btn-primary dropdown-toggle" type="button"
                                id="serviceKanbanMenu" data-bs-toggle="dropdown" aria-expanded="false">
                                            ...
                                            <tr class="align-middle">
                                                ...
                                                <td class="text-center">
                                                    ...
                                                    <div class="d-inline-flex align-items-center">
                                                        ...
                                                        <div class="type-icon bg-<?php echo e($event->color_class); ?> me-2"
                                                            title="<?php echo e($event->type_label); ?>">
                                                ...
                                                <td>
                                                    <div class="fw-bold text-dark">
                                                        <?php echo e($event->start_datetime->format('d.m.Y')); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\koksanissurecleriportali-main\resources\views/service/events/index.blade.php ENDPATH**/ ?>