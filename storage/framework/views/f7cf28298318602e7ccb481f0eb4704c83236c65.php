...
unset($__errorArgs, $__bag); ?>" id="name" name="name"
        value="<?php echo e(old('name', $travel->name ?? '')); ?>" required>
</div>
...
unset($__errorArgs, $__bag); ?>" id="start_date"
                name="start_date" value="<?php echo e(old('start_date', $travel->start_date ?? '')); ?>" required>
        </div>
    </div>
    <div class="col-md-6">
        <div class="mb-3">
...
unset($__errorArgs, $__bag); ?>" id="end_date"
                name="end_date" value="<?php echo e(old('end_date', $travel->end_date ?? '')); ?>" required>
        </div>
    </div>
</div>
