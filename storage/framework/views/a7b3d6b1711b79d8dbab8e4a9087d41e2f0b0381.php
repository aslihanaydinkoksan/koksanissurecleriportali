...
<?php $__env->startSection('title', 'Üretim Planları'); ?>
        ...
        <div class="row justify-content-center">
            <div class="col-12">
                ...
                <div class="mb-4 text-end">
                    ...
                    <button class="modern-btn modern-btn-primary dropdown-toggle" type="button" id="productionKanbanMenu"
                        data-bs-toggle="dropdown" aria-expanded="false">
                        <i class="fas fa-columns me-2"></i> Pano Görünümü
                    </button>
                    <ul class="dropdown-menu shadow border-0" aria-labelledby="productionKanbanMenu">
                        <?php $__empty_1 = true; $__currentLoopData = $productionBoards; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $board): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <li>
                                <a class="dropdown-item py-2"
                                    href="<?php echo e(route('kanban.board', ['board_id' => $board->id])); ?>">
                                    <i class="fas fa-industry text-warning me-2"></i> <?php echo e($board->name); ?>
                        ...
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                            <li>
                                <a class="dropdown-item py-2"
                                    href="<?php echo e(route('kanban-boards.create', ['scope' => 'production'])); ?>">
                                    <i class="fas fa-plus text-success me-2"></i> Yeni Üretim Panosu Oluştur
                                </a>
                            </li>
                        <?php endif; ?>
                    </ul>
