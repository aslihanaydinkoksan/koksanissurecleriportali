            ...
            <div class="col-md-8 h-100">
                <div class="tv-card">
                    <div class="d-flex justify-content-between align-items-center mb-3 border-bottom pb-2">
                        ...
                        <span class="badge bg-light text-dark fs-6">KÖKSAN -> Departmanlar -> İşlemler</span>
                    </div>
...
<?php $__env->startSection('page_scripts'); ?>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
                ...
                fetch("<?php echo e(route('tv.check_updates')); ?>")
                    ...
                    .then(data => {
                        if (data.hash !== currentHash) {
                            console.log('Veri değişti, sayfa yenileniyor...');
            ...
            if (document.body.scrollHeight > window.innerHeight) setTimeout(startTvScroll, 3000);
