...
<?php $__env->startSection('title', 'Yeni Takım Oluştur'); ?>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="mb-4">
                                ...
                                <textarea name="description" id="description" rows="3"
                                    class="form-control form-control-modern <?php $__errorArgs = ['description'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                                    placeholder="Takımın amacını veya görevlerini kısaca açıklayın..."><?php echo e(old('description')); ?></textarea>
                            </div>


                            <div class="d-flex flex-column flex-md-row justify-content-end gap-2 mt-5">
                                <a href="<?php echo e(route('teams.index')); ?>" class="btn btn-cancel-modern">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp82\htdocs\koksanissurecleriportali\resources\views/teams/create.blade.php ENDPATH**/ ?>