                        ...
                        <?php else: ?>
                            ...
                            <?php if($user->hasDepartmentPermission('view_maintenance')): ?>
                                <li class="nav-item dropdown">
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-end">
                                        <li><a class="dropdown-item" href="<?php echo e(route('maintenance.create')); ?>">
                                                <i class="fa-solid fa-plus-circle" style="color: #48BB78;"></i> Yeni Bakım
                                                Planı</a></li>
                                        <li><a class="dropdown-item" href="<?php echo e(route('maintenance.index')); ?>">
                                                <i class="fa-solid fa-clipboard-list" style="color: #4299E1;"></i>
                                                Planlanan Bakımlar Listesi</a></li>
                                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('approve_maintenance')): ?>
                                            <li>
                                                <hr class="dropdown-divider">
                                            </li>
                                            <li class="nav-item">
                                        ...
                                        <li><a class="dropdown-item" href="<?php echo e(route('maintenance.assets.index')); ?>">
                                ...
                                <?php elseif($authorizedUnits->count() == 1): ?>
                                    <li class="nav-item me-3 d-flex align-items-center">
                                        <span class="badge bg-white text-primary border px-3 py-2 rounded-pill shadow-sm"
                                            ...
                                            <i class="fa-solid fa-industry me-1"></i> <?php echo e($authorizedUnits->first()->name); ?>
                                ...
                                <div class="dropdown-menu dropdown-menu-end shadow-lg border-0"
                                    ...
                                    <div class="p-3 border-bottom d-flex justify-content-between align-items-center bg-light"
                                        ...
                                        <a href="<?php echo e(route('notifications.readAll')); ?>" id="mark-all-read"
                                            ...
                                            style="display: <?php echo e($unreadCount > 0 ? 'inline-block' : 'none'); ?>;">Tümünü
                                            Oku</a>
                                    </div>
                                            ...
                                            <a href="<?php echo e(route('notifications.read', $notification->id)); ?>"
                                                ...
                                                <div class="flex-grow-1">
                                                    ...
                                                    <small class="text-secondary fw-bold"
                                                        style="font-size: 0.7rem;"><?php echo e($notification->created_at->diffForHumans()); ?></small>
                                                </div>
                                            </a>
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <ul class="dropdown-menu dropdown-menu-end">
                                    <li><a class="dropdown-item" href="<?php echo e(route('profile.edit')); ?>"><i
                                            ...
                                            Düzenle</a></li>
                                    <li><a class="dropdown-item" href="<?php echo e(route('kanban-boards.index')); ?>"><i
                                    ...
                                    <?php if(\Spatie\Permission\PermissionServiceProvider::bladeMethodWrapper('hasRole', 'admin')): ?>
                                        ...
                                        <li><a class="dropdown-item" href="<?php echo e(route('users.index')); ?>"><i
                                                ...
                                                Görüntüle</a></li>
                                        <li><a class="dropdown-item" href="<?php echo e(route('business-units.index')); ?>"><i
                                        ...
                                        <li><a class="dropdown-item" href="<?php echo e(route('birimler.index')); ?>"><i
                                                ...
                                                Birimleri</a></li>
                                        <li><a class="dropdown-item" href="<?php echo e(route('admin.custom-fields.index')); ?>"><i
                                                    class="fa-solid fa-wpforms" style="color: #00177c;"></i> Form Alanları</a>
                                        </li>
                                        <li><a class="dropdown-item" href="<?php echo e(route('report-settings.index')); ?>"><i
        ...
        <div id="chat-window">
            ...
            <div id="chat-body">
                <div class="message-bubble ai-msg">
                    👋 Merhaba <?php echo e(Auth::user() ? Auth::user()->name : 'Misafir'); ?>! Ben KÖKSAN yapay zeka asistanı
                    KökGPT!
                    <br><br>
...
<?php /**PATH C:\xampp\htdocs\koksanissurecleriportali-main\resources\views/layouts/app.blade.php ENDPATH**/ ?>