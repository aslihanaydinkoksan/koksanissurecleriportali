...
<?php $__env->startPush('styles'); ?>
    <style>
        ...
        /* Önemli switch butonu aktifken kırmızı olsun */
        ...
        .form-check-label[for="is_important"] {
            cursor: pointer;
            font-size: 0.9rem;
        }
    </style>
                    ...
                    <div class="card-body p-4">
                        ...
                        <form method="POST" action="<?php echo e(route('service.events.store')); ?>" enctype="multipart/form-data">
                            ...
                            <?php if(isset($selectedCustomerId) && $selectedCustomerId): ?>
                                <input type="hidden" name="redirect_to_customer" value="<?php echo e($selectedCustomerId); ?>">
                            <?php endif; ?>
...
unset($__errorArgs, $__bag); ?>" required>
                                                ...
                                                <?php $__currentLoopData = $eventTypes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option value="<?php echo e($key); ?>"
                                                        <?php if(old('event_type') == $key): ?> selected <?php endif; ?>>
                                                        <?php echo e($value); ?>
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <?php if(isset($selectedCustomerId) && $selectedCustomerId): ?>
                                                            <input type="hidden" name="customer_id"
                                                                value="<?php echo e($selectedCustomerId); ?>">
                                                            <select id="customer_id" class="form-select bg-light" disabled>
                                                                <?php $__currentLoopData = $customers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $customer): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                    <?php if($customer->id == $selectedCustomerId): ?>
                                                                        <option value="<?php echo e($customer->id); ?>" selected>
...
unset($__errorArgs, $__bag); ?>">
                                                            ...
                                                            <option value="egitim"
                                                                <?php if(old('visit_purpose') == 'egitim'): ?> selected <?php endif; ?>>Eğitim
                                                            </option>
                                                            <option value="rutin_ziyaret"
                                                                <?php if(old('visit_purpose') == 'rutin_ziyaret'): ?> selected <?php endif; ?>>Rutin
                                                                Ziyaret</option>
                                                            <option value="pazarlama"
                                                                <?php if(old('visit_purpose') == 'pazarlama'): ?> selected <?php endif; ?>>
                                                                Pazarlama Amaçlı Ziyaret</option>
                                                            <option value="diger"
                                                                <?php if(old('visit_purpose') == 'diger'): ?> selected <?php endif; ?>>Diğer
                                                            </option>
                                                        </select>
                                                    </div>
                                                </div>
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="col-12 mt-3">
                                        <div class="card border-0 bg-light shadow-sm">
                                            <div class="card-body">
                                                <label for="attachments" class="form-label fw-bold">Ek Dosyalar</label>
                                                <input type="file" name="attachments[]" id="attachments"
                                                    class="form-control" multiple
                                                    accept=".jpeg,.jpg,.png,.pdf,.doc,.docx,.xls,.xlsx">
                                                <div class="form-text">
                                                    Birden fazla dosya seçebilirsiniz. (JPEG, PNG, PDF, Word, Excel) Dosya
                                                    boyutu maksimum 20 MB olabilir.
                                                </div>
                                            </div>
                                        </div>
                                    </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\koksanissurecleriportali-main\resources\views/service/events/create.blade.php ENDPATH**/ ?>