...
<?php $__env->startSection('content'); ?>
    ...
    <div class="dashboard-wrapper">
                            ...
                            <select name="target_dept" id="deptSelect" class="form-select modern-select">
                                <?php if($isSuperUser): ?>
                                    <option value="genel" <?php echo e($departmentSlug == 'genel' ? 'selected' : ''); ?>>📊 Genel Bakış
                                        (<?php echo e($activeUnitName); ?>)</option>
                                <?php endif; ?>
        ...
        <div id="stats-data-container" style="display: none;" data-chart-data='<?php echo json_encode($chartData ?? [], 15, 512) ?>'
            ...
            <?php elseif($departmentSlug === 'uretim'): ?> data-production-plans='<?php echo json_encode($productionPlansForFiltering ?? [], 15, 512) ?>'
            <?php elseif($departmentSlug === 'hizmet'): ?> data-events='<?php echo json_encode($eventsForFiltering ?? [], 15, 512) ?>'
            <?php elseif($departmentSlug === 'ulastirma'): ?> data-assignments='<?php echo json_encode($assignmentsForFiltering ?? [], 15, 512) ?>' data-vehicles='<?php echo json_encode($vehiclesForFiltering ?? [], 15, 512) ?>'
            ...
            <div class="row g-4">
                <div class="col-lg-8">
                    <div class="chart-container">
                        <div class="chart-header">📊 <?php echo e($activeUnitName); ?> - Aktivite Özeti</div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\wwwroot\koksan_is_surecleri\resources\views/statistics/index.blade.php ENDPATH**/ ?>