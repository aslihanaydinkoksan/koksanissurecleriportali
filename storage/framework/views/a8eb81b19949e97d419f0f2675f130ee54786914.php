...
unset($__errorArgs, $__bag); ?>" required>
                                            ...
                                            <option value="tır" <?php if(old('arac_tipi', $shipment->arac_tipi) == 'tır'): ?> selected <?php endif; ?>>Tır
                                            </option>
                                            <option value="gemi" <?php if(old('arac_tipi', $shipment->arac_tipi) == 'gemi'): ?> selected <?php endif; ?>>Gemi
                                            </option>
                                            <option value="kamyon" <?php if(old('arac_tipi', $shipment->arac_tipi) == 'kamyon'): ?> selected <?php endif; ?>>Kamyon
                                            </option>
                                        </select>
...
unset($__errorArgs, $__bag); ?>"
                                                id="plaka" name="plaka" value="<?php echo e(old('plaka', $shipment->plaka)); ?>"
                                                autocomplete="off">
...
unset($__errorArgs, $__bag); ?>" id="sofor_adi"
                                                name="sofor_adi" value="<?php echo e(old('sofor_adi', $shipment->sofor_adi)); ?>"
                                                autocomplete="off">
...
unset($__errorArgs, $__bag); ?>
                                        ...
                                        <div class="mb-3">
                                            <label for="kalkis_noktasi" class="form-label">Kalkış Noktası
                                                (Gümrük/Tesis)</label>
                                            <input type="text"
                                                class="form-control <?php $__errorArgs = ['kalkis_noktasi'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                                        ...
                                        <div class="mb-3">
                                            <label for="varis_noktasi" class="form-label">Varış Noktası
                                                (Gümrük/Tesis)</label>
                                            <input type="text"
                                                class="form-control <?php $__errorArgs = ['varis_noktasi'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                                                ...
                                                value="<?php echo e(old('gemi_adi', $shipment->gemi_adi)); ?>" autocomplete="off">
...
unset($__errorArgs, $__bag); ?>"
                                                ...
                                                value="<?php echo e(old('kalkis_limani', $shipment->kalkis_limani)); ?>"
                                                autocomplete="off">
...
unset($__errorArgs, $__bag); ?>"
                                                ...
                                                value="<?php echo e(old('varis_limani', $shipment->varis_limani)); ?>"
                                                autocomplete="off">
...
unset($__errorArgs, $__bag); ?>"
                                            ...
                                            value="<?php echo e(old('cikis_tarihi', \Carbon\Carbon::parse($shipment->cikis_tarihi)->format('Y-m-d\TH:i'))); ?>"
...
unset($__errorArgs, $__bag); ?>"
                                            ...
                                            value="<?php echo e(old('tahmini_varis_tarihi', \Carbon\Carbon::parse($shipment->tahmini_varis_tarihi)->format('Y-m-d\TH:i'))); ?>"
                                            required autocomplete="off">
...
unset($__errorArgs, $__bag); ?>" required>
                                            ...
                                            <?php $__currentLoopData = $birimler; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $birim): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($birim->ad); ?>"
                                                    <?php if(old('kargo_tipi', $shipment->kargo_tipi) == $birim->ad): ?> selected <?php endif; ?>><?php echo e($birim->ad); ?>
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <?php if($shipment->dosya_yolu): ?>
                                        <div class="mb-3 border p-2 rounded"
                                            ...
                                            <a href="<?php echo e(\Illuminate\Support\Facades\Storage::url($shipment->dosya_yolu ? asset('storage/' . $shipment->dosya_yolu) : null)); ?>"
...
unset($__errorArgs, $__bag); ?>" id="aciklamalar" name="aciklamalar"
                                            rows="5" autocomplete="off"><?php echo e(old('aciklamalar', $shipment->aciklamalar)); ?></textarea>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\koksanissurecleriportali\resources\views/shipments/edit.blade.php ENDPATH**/ ?>