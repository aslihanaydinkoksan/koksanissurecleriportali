...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="info-box mb-4">
                                <div class="info-box-content">
                                    ...
                                    <?php echo e($assignment->start_time ? $assignment->start_time->format('d.m.Y H:i') : 'Henüz Belirlenmedi'); ?>
                                ...
                                <?php if($isManager): ?>
                                    <div class="mb-4">
                                        <div class="alert alert-light border">
                                            ...
                                            Şu anki durum:
                                            <strong><?php echo e($assignment->vehicle ? 'Araç Atanmış' : 'Araç Bekleniyor'); ?></strong>.
                                            ...
                                            <select name="vehicle_id" class="form-select">
                                                ...
                                                <?php $__currentLoopData = $companyVehicles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $vehicle): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option value="<?php echo e($vehicle->id); ?>"
                                                        <?php echo e($assignment->vehicle_id == $vehicle->id ? 'selected' : ''); ?>>
                                            ...
                                            <div class="alert alert-success d-flex align-items-center">
                                                ...
                                                <div>
                                                    ...
                                                    <p class="mb-0">
                                                        ...
                                                        <span
                                                            class="text-muted small">(<?php echo e($assignment->vehicle->brand_model ?? $assignment->vehicle->brand); ?>)</span>
                                                    </p>
                                                </div>
                                            </div>
                                        ...
                                        <div class="row mb-4">
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <input type="number" step="0.1" name="start_km"
                                                    class="form-control" value="<?php echo e($assignment->start_km); ?>">
                                            </div>
                                            <div class="col-md-6 mb-3">
                                                <label class="form-label">⛽ Başlangıç Yakıt</label>
                                                <select name="start_fuel_level" class="form-select">
                                                    <?php $__currentLoopData = ['full', '3/4', '1/2', '1/4', 'empty']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lvl): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <option value="<?php echo e($lvl); ?>"
                                                            <?php echo e($assignment->start_fuel_level == $lvl ? 'selected' : ''); ?>>
                                                            <?php echo e($lvl); ?></option>
                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                </select>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row mb-4">
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <input type="text" class="form-control readonly-field"
                                                    value="<?php echo e($assignment->start_km ? number_format($assignment->start_km, 2) . ' km' : '-'); ?>"
                                                    disabled readonly>
                                            </div>
                                            <div class="col-md-6 mb-3">
                                    ...
                                    <div class="row mb-4">
                                        ...
                                        <div class="col-md-4 mb-3">
                                            ...
                                            <input type="number" step="0.01" name="fuel_cost" id="fuel_cost"
                                                class="form-control"
                                                value="<?php echo e(old('fuel_cost', $assignment->fuel_cost)); ?>"
                                    ...
                                    <select name="customer_id" class="form-select">
                                        ...
                                        <?php $__currentLoopData = $customers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $customer): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($customer->id); ?>"
                                                <?php echo e(old('customer_id', $assignment->customer_id) == $customer->id ? 'selected' : ''); ?>>
