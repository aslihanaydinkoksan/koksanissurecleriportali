            ...
            <div class="col-md-10">
                ...
                <div class="card create-plan-card">
                    ...
                    <div class="card-body p-4">
                        ...
                        <form method="POST" action="<?php echo e(route('production.plans.store')); ?>">
                            <?php echo csrf_field(); ?>
                            <div class="row">
...
unset($__errorArgs, $__bag); ?>"
                                                        placeholder="Adet" value="<?php echo e($details['quantity'] ?? ''); ?>"
                                                        required min="1">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\aslihan.aydin\Desktop\tedarik-yonetimi\tedarik-yonetimi\resources\views/production/plans/create.blade.php ENDPATH**/ ?>