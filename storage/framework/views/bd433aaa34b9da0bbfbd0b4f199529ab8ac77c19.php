                    ...
                    <div>
                        ...
                        <div class="dropdown d-inline-block">
                            <button class="modern-btn modern-btn-primary dropdown-toggle" type="button"
                                id="maintenanceKanbanMenu" data-bs-toggle="dropdown" aria-expanded="false">
                                <i class="fas fa-columns me-2"></i> Pano Görünümü
                            </button>
                            <ul class="dropdown-menu shadow border-0" aria-labelledby="maintenanceKanbanMenu">
                                <?php $__empty_1 = true; $__currentLoopData = $maintenanceBoards; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $board): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <li>
                                        <a class="dropdown-item py-2"
                                            href="<?php echo e(route('kanban.board', ['board_id' => $board->id])); ?>">
                                            <i class="fas fa-tools text-danger me-2"></i> <?php echo e($board->name); ?>
                                ...
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                                    <li>
                                        <a class="dropdown-item py-2"
                                            href="<?php echo e(route('kanban-boards.create', ['scope' => 'maintenance'])); ?>">
                                            <i class="fas fa-plus text-success me-2"></i> Yeni Bakım Panosu Oluştur
                                        </a>
                                    </li>
                                <?php endif; ?>
                            </ul>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/koksan-takvim/resources/views/maintenance/index.blade.php ENDPATH**/ ?>