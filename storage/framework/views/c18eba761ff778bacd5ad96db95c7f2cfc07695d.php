                                    ...
                                    <div class="row g-3">
                                        <?php if($departments->count() > 0): ?>
                                            <?php $__currentLoopData = $departments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dept): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <div class="col-md-6">
                                                    <label class="list-item" for="dept_<?php echo e($dept->id); ?>">
                                                        <input type="checkbox" name="departments[]"
                                                            id="dept_<?php echo e($dept->id); ?>" value="<?php echo e($dept->id); ?>"
                                                            class="list-checkbox" 
                                                            <?php if(in_array($dept->id, old('departments', $userDepartments))): ?> checked <?php endif; ?>>

                                                        <span class="text-dark"><?php echo e($dept->name); ?></span>
                                                    </label>
                                                </div>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        <?php else: ?>
                                ...
                                <div class="list-wrapper factory-wrapper">
                                    <div class="row g-3">
                                        <?php $__currentLoopData = $businessUnits; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $unit): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <div class="col-md-6">
                                                <label class="list-item" for="unit_<?php echo e($unit->id); ?>">
                                                    <input type="checkbox" name="units[]" id="unit_<?php echo e($unit->id); ?>"
                                                        value="<?php echo e($unit->id); ?>" class="list-checkbox"
                                                        <?php if(in_array($unit->id, old('units', $userUnits))): ?> checked <?php endif; ?>>
                                                    <span class="fw-bold text-dark"><?php echo e($unit->name); ?></span>
                                                </label>
                                            </div>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </div>
                                    ...
                                    <?php $__currentLoopData = $roles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $role): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <div>
                                            <input type="radio" name="role" id="role_<?php echo e($role->id); ?>"
                                                ...
                                                <?php echo e(old('role') == $role->name || (!old('role') && $user->hasRole($role->name)) ? 'checked' : ''); ?>>
...
$message = $__bag->first($__errorArgs[0]); ?>
                                    <small class="text-danger ms-2"><?php echo e($message); ?></small>
                                <?php unset($message);
