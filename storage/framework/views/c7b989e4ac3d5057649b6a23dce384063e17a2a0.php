            ...
            <div class="col-md-10 col-lg-9">
                ...
                <div class="page-header">
                    <div class="d-flex justify-content-between align-items-center flex-wrap gap-3">
                        ...
                        <a href="<?php echo e(route('my-assignments.index')); ?>" class="btn btn-back">
                ...
                <div class="card detail-card">
                    <div class="card-header">
                        <div class="d-flex justify-content-between align-items-center flex-wrap gap-2">
                            ...
                            <span class="badge bg-primary"><?php echo e($assignment->getStatusNameAttribute()); ?></span>
                        </div>
                    </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                                        ...
                                        <?php
                                            ...
                                            $responsibleType =
                                                $assignment->responsible_type === App\Models\User::class
                                                    ...
                                                    : 'Takım';
                                        ?>
                                        <i class="fas fa-<?php echo e($responsibleType === 'Kişi' ? 'user' : 'users'); ?>"></i>
                                        Sorumlu
                                    </div>
                                    <p class="info-value">
                                        <?php echo e($responsibleName); ?>

                                        <small class="text-muted">(<?php echo e($responsibleType); ?>)</small>
                                    </p>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="info-box">
                                    ...
                                    <p class="info-value">
                                        <?php echo e($assignment->start_time->format('d.m.Y H:i')); ?> -
                                        <?php echo e($assignment->end_time->format('H:i')); ?>
                        ...
                        <div class="description-box">
                            ...
                            <p><?php echo e($assignment->task_description); ?></p>
                        </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp82\htdocs\koksanissurecleriportali\resources\views/service/assignments/show.blade.php ENDPATH**/ ?>