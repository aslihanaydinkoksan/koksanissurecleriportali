...
unset($__errorArgs, $__bag); ?>" id="task_description"
                                    name="task_description" rows="3" required placeholder="Ne yapılması gerekiyor? Detaylı açıklayın..."><?php echo e(old('task_description', $assignment->task_description)); ?></textarea>
