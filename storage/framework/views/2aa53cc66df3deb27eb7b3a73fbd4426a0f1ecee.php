        ...
        <div class="col-md-8">
            ...
            <div class="timeline" id="activitiesList">
                <?php $__empty_1 = true; $__currentLoopData = $customer->activities; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $activity): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <div class="card mb-3 border-0 shadow-sm activity-item" data-date="<?php echo e($activity->activity_date->format('Y-m-d')); ?>" data-search="<?php echo e(mb_strtolower($activity->description . ' ' . ($activity->user->name ?? '') . ' ' . implode(' ', $activity->contact_persons ?? []))); ?>" data-status="<?php echo e($activity->type); ?>">
                        <div class="card-body position-relative">
                            ...
                            <div class="d-flex justify-content-between align-items-center mb-2 ps-2 pe-5">
                                ...
                                <small class="text-muted fst-italic"><i class="fas fa-user-circle me-1"></i><?php echo e($activity->user->name); ?></small>
                            </div>
                            <div class="ps-2 mt-2">
...
</div><?php /**PATH C:\xampp\htdocs\koksanissurecleriportali-main\resources\views/customers/tabs/activities.blade.php ENDPATH**/ ?>