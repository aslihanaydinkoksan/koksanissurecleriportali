<?php $__env->startSection('title', 'Müşteri Bilgilerini Düzenle'); ?>
            ...
            <div class="col-md-10 col-lg-9">
                <div class="customer-card">
                    ...
                    <div class="card-body">
                        ...
                        <form action="<?php echo e(route('customers.update', $customer)); ?>" method="POST" autocomplete="off"
                            enctype="multipart/form-data">
                            <?php echo csrf_field(); ?>
                            <?php echo method_field('PUT'); ?>

                            <div class="form-section">
                                <?php echo $__env->make('customers._form', ['customer' => $customer], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                            </div>

                            <div class="action-buttons">
                                <a href="<?php echo e(route('customers.show', $customer)); ?>" class="btn btn-outline-secondary">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\koksanissurecleriportali-main\resources\views/customers/edit.blade.php ENDPATH**/ ?>