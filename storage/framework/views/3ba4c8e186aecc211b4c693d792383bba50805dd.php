            ...
            <div class="header-content">
                ...
                <div class="stats">
                    ...
                    <div class="dropdown d-inline-block">
                        <button class="modern-btn modern-btn-primary dropdown-toggle" type="button" id="kanbanMenu"
                            data-bs-toggle="dropdown" aria-expanded="false">
                            <i class="fas fa-columns me-2"></i> Pano Görünümü
                        </button>
                        <ul class="dropdown-menu shadow border-0" aria-labelledby="kanbanMenu">
                            <?php $__empty_1 = true; $__currentLoopData = $logisticsBoards; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $board): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <li>
                                    <a class="dropdown-item py-2"
                                        href="<?php echo e(route('kanban.board', ['board_id' => $board->id])); ?>">
                                        <i class="fas fa-chalkboard text-primary me-2"></i> <?php echo e($board->name); ?>
                            ...
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                                <li>
                                    <a class="dropdown-item py-2"
                                        href="<?php echo e(route('kanban-boards.create', ['scope' => 'logistics'])); ?>">
                                        <i class="fas fa-plus text-success me-2"></i> Yeni Pano Oluştur
                                    </a>
                                </li>
                            <?php endif; ?>
                        </ul>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\koksanissurecleriportali-main\resources\views/shipments/list.blade.php ENDPATH**/ ?>