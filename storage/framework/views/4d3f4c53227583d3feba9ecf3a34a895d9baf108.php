        ...
        <div class="row justify-content-center">
            <div class="col-lg-12">
                ...
                <div
                    ...
                    <a href="<?php echo e(route('customers.create')); ?>" class="btn btn-primary-gradient rounded-pill px-4 btn-modern">
                        <i class="fa-solid fa-plus me-1"></i> Yeni Müşteri Ekle
                    </a>
                </div>
                <div class="card-body px-4">

                    <form method="GET" action="<?php echo e(route('customers.index')); ?>" class="mb-3" autocomplete="off">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\koksanissurecleriportali\resources\views/customers/index.blade.php ENDPATH**/ ?>