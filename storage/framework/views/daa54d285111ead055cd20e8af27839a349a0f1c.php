                                        ...
                                        <tr>
                                            ...
                                            <td class="text-end">
                                                <div class="btn-group" role="group">
                                                    ...
                                                    <?php if(auth()->user()->hasRole(['super-admin', 'admin', 'yonetici'])): ?>
                                                    <form action="<?php echo e(route('customers.destroy', $customer)); ?>" method="POST" class="d-inline" onsubmit="return confirm('Bu müşteriyi silmek istediğinize emin misiniz?')">
                                                        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/koksan-takvim/resources/views/customers/index.blade.php ENDPATH**/ ?>