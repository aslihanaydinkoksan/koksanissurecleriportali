                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select name="shipment_status" id="shipment_status"
                                            ...
                                            <option value="pending"
                                                <?php echo e(old('shipment_status', $shipment->shipment_status) == 'pending' ? 'selected' : ''); ?>>
                                                📋 Sipariş Alındı (Bekliyor)
                                            </option>
                                            <option value="on_road"
                                                <?php echo e(old('shipment_status', $shipment->shipment_status) == 'on_road' ? 'selected' : ''); ?>>
                                                🚚 Yolda (Transit)
                                            </option>
                                            <option value="delivered"
                                                <?php echo e(old('shipment_status', $shipment->shipment_status) == 'delivered' ? 'selected' : ''); ?>>
                                                ✅ Teslim Edildi
                                            </option>
                                        </select>
