            ...
            <tbody>
                <?php $__empty_1 = true; $__currentLoopData = $customer->returns; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $return): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <tr class="return-item" 
                        id="return-complaint-<?php echo e($return->complaint_id); ?>"
                        ...
                        <td>
                            <?php if($return->remote_system === 'iaa' && $return->remote_url): ?>
                                <a href="<?php echo e($return->remote_url); ?>" target="_blank" class="fw-bold text-dark text-decoration-none hover-primary" title="IAA Proje Çalışma Alanında Görüntüle">
                                    <?php echo e($return->product_name); ?> <i class="fas fa-external-link-alt ms-1 text-info" style="font-size: 0.7rem;"></i>
                                </a>
                            <?php else: ?>
                                <span class="fw-bold text-dark"><?php echo e($return->product_name); ?></span>
                            <?php endif; ?>

                            <?php if($return->remote_system === 'iaa'): ?>
                                <?php if($return->remote_url): ?>
                                    <a href="<?php echo e($return->remote_url); ?>" target="_blank" class="badge bg-info bg-opacity-10 text-info border border-info ms-1 text-decoration-none" style="font-size: 0.65rem;" title="IAA Proje Çalışma Alanında Görüntüle">
                            ...
                            <?php if($return->complaint_id): ?>
                                <br><a href="#complaint-<?php echo e($return->complaint_id); ?>" 
                                       onclick="event.preventDefault(); scrollToComplaint(<?php echo e($return->complaint_id); ?>)" 
                                       ...
                                       title="Şikayete Git">
                                       <i class="fa-solid fa-circle-exclamation me-1"></i> Şikayet #<?php echo e($return->complaint_id); ?>
                        ...
                        <td>
                            <form action="<?php echo e(route('customer-returns.update-status', $return->id)); ?>" method="POST">
                                ...
                                <select name="status" class="form-select status-select status-<?php echo e($return->status); ?>"
                                    onchange="this.form.submit()" <?php if($return->remote_system === 'iaa'): ?> disabled <?php endif; ?>>
...
<?php /**PATH /var/www/koksan-takvim/resources/views/customers/tabs/returns.blade.php ENDPATH**/ ?>