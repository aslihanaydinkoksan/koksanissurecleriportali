    ...
    <nav class="d-flex justify-items-center justify-content-between">
        ...
        <div class="d-none flex-sm-fill d-sm-flex align-items-sm-center justify-content-sm-between">
            <div class="small text-muted">
                Toplam <span class="fw-bold"><?php echo e($paginator->total()); ?></span> kayıttan
                <span class="fw-bold"><?php echo e($paginator->firstItem()); ?></span> -
                <span class="fw-bold"><?php echo e($paginator->lastItem()); ?></span> arası gösteriliyor
            </div>
...
<?php endif; ?>
<?php /**PATH C:\xampp82\htdocs\koksanissurecleriportali\resources\views/vendor/pagination/bootstrap-5.blade.php ENDPATH**/ ?>