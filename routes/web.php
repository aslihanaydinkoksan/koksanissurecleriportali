...
Route::middleware(['auth'])->group(function () {
    ...
    Route::prefix('notifications')->name('notifications.')->group(function () {
        ...
        Route::middleware(['role:admin|superadmin|yonetici'])->group(function () {
            ...
            Route::middleware(['role:admin|superadmin|yonetici'])
                ->prefix('admin')
                ->name('admin.')
                ->group(function () {
        ...
        Route::prefix('service')->name('service.')->group(function () {
            ...
            Route::get('/visits/{visit}', [App\Http\Controllers\CustomerVisitController::class , 'show'])->name('visits.show');
        ...
        Route::delete('/todos/{todo}', [App\Http\Controllers\TodoController::class , 'destroy'])->name('todos.destroy');    }); // End of Auth Middleware
